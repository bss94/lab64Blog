  ...
  return !isLoading && (
    <>
      ...
      <Col sm={10}>
        ...
        <p className="mt-5 fs-6 text-muted mb-5">Now study on period: <strong>{about.period}</strong></p>
        <NavLink to={'/contacts'} className='nav-link mt-5 text-center'><Button className='btn-primary'>Contact us</Button></NavLink>
      </Col>
      <Col/>
    </>
  );
